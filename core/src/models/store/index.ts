...
module.exports = {
    ...
    getFriendGuardDogBlacklist: accountConfig.getFriendGuardDogBlacklist,
    setFriendGuardDogBlacklist: accountConfig.setFriendGuardDogBlacklist,
    addFriendGuardDogBlacklistGid: accountConfig.addFriendGuardDogBlacklistGid,
    removeFriendGuardDogBlacklistGid: accountConfig.removeFriendGuardDogBlacklistGid,
    getFriendGuardDogWhitelist: accountConfig.getFriendGuardDogWhitelist,
    setFriendGuardDogWhitelist: accountConfig.setFriendGuardDogWhitelist,
    addFriendGuardDogWhitelistGid: accountConfig.addFriendGuardDogWhitelistGid,
    removeFriendGuardDogWhitelistGid: accountConfig.removeFriendGuardDogWhitelistGid,
