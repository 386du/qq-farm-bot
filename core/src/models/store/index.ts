...
module.exports = {
    ...
    getNoGuardDogAtMap: accountConfig.getNoGuardDogAtMap,
    getNoGuardDogCacheTtlSec: accountConfig.getNoGuardDogCacheTtlSec,
    setNoGuardDogCacheTtlSec: accountConfig.setNoGuardDogCacheTtlSec,
    markNoGuardDog: accountConfig.markNoGuardDog,
    unmarkNoGuardDog: accountConfig.unmarkNoGuardDog,
    clearNoGuardDogCache: accountConfig.clearNoGuardDogCache,
    isNoGuardDogCacheFresh: accountConfig.isNoGuardDogCacheFresh,
    getNoGuardDogCacheStats: accountConfig.getNoGuardDogCacheStats,
    ...
    getGoConfig: globalConfig.getGoConfig,
    setGoConfig: globalConfig.setGoConfig,
    deleteUserGoConfig: globalConfig.deleteUserGoConfig,
