...
<template>
  <div class="space-y-4">
    <div class="farm-card-enhanced flex flex-wrap items-center justify-between gap-3 p-4">
      <div>
    ...
    <div
      ...
      class="farm-card-enhanced p-8 text-center text-sm text-gray-500"
    >
      请先选择账号。
    </div>
    ...
    <div v-else class="grid gap-4 lg:grid-cols-2">
      <section class="farm-card-enhanced p-4">
